...
export default function (row) {
     ...
     *
     */
    if (techterms[row.key])
        row.tech = true;
    else if (row.singular && techterms[row.singular])
        row.tech = true;
    else if (row.plural && techterms[row.plural])
        row.tech = true;
    else if (row.root && techterms[row.root])
        row.tech = true;
    else if (row.acronym && techterms[row.acronym])
        row.tech = true;
    /*
     *
     * stopword ?
